...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if (isset($_POST['action']) && isset($_POST["text1"]) && $_POST['action'] == 2){
        $text1 = $_POST["text1"];
        var_dump(getTopLongestWords($text1, 4));
        echo "<br>";
    }
...
<form method="post" action="" >
    <label for="test">Input1</label>
    <input name="test" type="text" id="test"> Текст
    ...
    <div style="clear: both"></div>
    <label for="test">Text 2</label>
    <textarea name="text2" id="text2" cols="30" rows="10"></textarea>

    <input type="text" name="action" value="2"> Выбор (1, 2, 3)
